...
public class UpdateConcept extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String classCount = request.getParameter("questionClassCount2");
		...
		{			
			...
			{
				String selected = request.getParameter(i+"RowSelected2");
			    if (selected != null)
			    {
			    	  className = request.getParameter(i+"ConceptClass2"); 
			    	  lines = request.getParameter(i+"RowLines2");
			    	  if (lines.endsWith(";"))
